...
<body>
   ...
   <div class="p-4 sm:ml-64 h-full grid justify-items-center" >
    <div class="justify-center">
      <form action="upload.php" method="post" enctype="multipart/form-data" class="shadow-none">
        ...
        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg mb-2" id="book_profile" name="book_profile" id="book_profile" type="file" accept=".png, .jpeg, .jpg" required>

        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg mb-2" id="book_title" name="book_title" type="text" placeholder="Enter book title" required>
        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg mb-2" id="book_author" name="book_author" type="text" placeholder="Enter author" required>
        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg mb-2" id="book_no" name="book_no" type="number" placeholder="Enter book number" required>
